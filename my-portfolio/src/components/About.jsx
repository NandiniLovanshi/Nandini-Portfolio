function About() {
  return (
    <section
      id="about"
      className="min-h-screen bg-white dark:bg-slate-900 text-slate-900 dark:text-white flex items-center justify-center px-10 py-20 transition-all duration-500"
    >
      <div className="max-w-5xl">

        {/* Heading */}
        <h4 className="text-cyan-500 dark:text-cyan-400 text-xl font-semibold text-center mb-3">
          ABOUT ME
        </h4>
        ...
        {/* Introduction */}
        <p className="text-gray-700 dark:text-gray-300 text-[18px] leading-10 text-center max-w-4xl mx-auto transition-all duration-500">
          Hello! I'm{" "}
